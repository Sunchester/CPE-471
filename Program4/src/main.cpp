...
public:
	...
	//texture data
	GLuint Texture, TextureN, TextureSpec;
	GLuint TextureNight;
	...
	{	
		...
		//texture Earth
		string str = resourceDirectory + "/8k_earth_daymap_flip.jpg";
		...
		str = resourceDirectory + "/8k_earth_clouds_flip.jpg";
		strcpy(filepath, str.c_str());
		...
		GLuint TexSLocation = glGetUniformLocation(prog->pid, "tex3");
		GLuint TexNLocation = glGetUniformLocation(prog->pid, "texN");
	...
	void init(const std::string& resourceDirectory)
	{
		...
		prog_framebuffer->addUniform("onGamma");
	...
	void render()
	{
		...
		glBindTexture(GL_TEXTURE_2D, FBOtex);
		glBindVertexArray(VertexArrayIDRect);
		glUniform1i(prog_framebuffer->getUniform("onGamma"), gamma);
	...
	********/
	void render_to_framebuffer()
	{
		...
		/*float sangle = 3.1415926;*/
		glm::mat4 RotateY = glm::rotate(glm::mat4(1.0f), w, glm::vec3(0.0f, 1.0f, 0.0f));
		glm::mat4 RotateX = glm::rotate(glm::mat4(1.0f), (sangle), glm::vec3(1.0f, 0.0f, 0.0f));
		glm::mat4 RotateZ = glm::rotate(glm::mat4(1.0f), -0.20f, glm::vec3(0.0f, 0.0f, 1.0f));
		...
		glm::mat4 TransZ = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -5));
		glm::mat4 S = glm::scale(glm::mat4(1.0f), glm::vec3(1.5f, 1.5f, 1.5f));
		M = TransZ  * RotateY * RotateZ* RotateX * S;
